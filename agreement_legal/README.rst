...
-  [STRIKEOUT:Split the module to remove the dependencies on sale and
   account and provide the same feature in extra modules
   (agreement_sale, agreement_account, agreement_purchase)] Done: sale
   and account dependencies have been moved to their respective extra
   modules (agreement_sale, agreement_account). No purchase-related
   features remain in this module, so agreement_purchase is not needed
   here.
