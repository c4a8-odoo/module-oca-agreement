...
class TestCreateAgreementWizard(TransactionCase):
    ...
    def test_create_agreement(self):
        ...
        self.assertEqual(agreement.recital_ids[0].name, template.recital_ids[0].name)
        self.assertEqual(agreement.sections_ids[0].name, template.sections_ids[0].name)
        self.assertEqual(len(agreement.clauses_ids), len(template.clauses_ids))
        self.assertEqual(agreement.clauses_ids[0].name, template.clauses_ids[0].name)
        self.assertIn(agreement.clauses_ids[0].section_id, agreement.sections_ids)
        self.assertEqual(agreement.appendix_ids[0].name, template.appendix_ids[0].name)
